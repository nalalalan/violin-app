...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.22\textwidth}p{0.18\textwidth}p{0.48\textwidth}}
        ...
        Rendered wall & 162 tiles & A stricter display gate selects full pale-background backs with one-piece or visually continuous flame, explicit Stradivari, Amati, Guarneri, and other historically important full-back views, plus the three acceptable user-selected lead images. \\
        \bottomrule
    \end{tabular}
\end{table}
